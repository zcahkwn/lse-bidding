/*
  ...
  1. Database Structure
    - Enhanced bids table with proper foreign key relationships
    - Indexes for performance optimization
    - RLS policies for security

  2. Functions
    - get_opportunity_bid_count: Get bid count for an opportunity
    - student_has_bid: Check if student has bid on opportunity
    - get_student_bid_status: Get student's bid status across all opportunities
    - get_class_opportunity_bid_counts: Get all bid counts for class opportunities
    - submit_student_bid_secure: Enhanced secure bid submission
    - get_class_bid_statistics: Real-time statistics for admin dashboard
